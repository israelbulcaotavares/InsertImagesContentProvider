...
public class PetProvider extends ContentProvider {
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        String imaggem = values.getAsString(PetContract.PetEntry.COLUMN_IMAGEM);
        if (imaggem == null) {
    ...
    private int updatePet(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(PetContract.PetEntry.COLUMN_IMAGEM)) {
            String name = values.getAsString(PetContract.PetEntry.COLUMN_IMAGEM);
            if (name == null) {
                throw new IllegalArgumentException("Pet requires a image");
            }
        }
